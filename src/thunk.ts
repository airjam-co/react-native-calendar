import {
  ...
  CALENDAR_MY_RESERVATIONS_ENDPOINT,
...
export const fetchMyReservations = async (
  ...
  authToken?: string,
  host?: string
): Promise<EventReservation[] | undefined> => {
...
export const submitBookReservation = async (
  ...
  bookingRequest.resourceId = resource
    ? resource.resource._id
    : event
    ? event.componentResourceId
    : '';
  ...
  const bookResponse = await bookReservation(
    componentId,
    bookingRequest,
    host,
    authToken
