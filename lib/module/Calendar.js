...
import { GetEventsDuration, CalendarViewType as ViewType, addDays } from '@airjam/types';
...
import { deleteReservation, fetchCalendarView, fetchMyReservations, fetchReservationTerms, submitBookReservation } from './thunk';
...
export const Calendar = ({
  ...
  const [bookingDialog, setBookingDialog] = React.useState(undefined);
  const [bookingResult, setBookingResult] = React.useState(undefined);
  const [selectedReservation, setSelectedReservation] = React.useState(undefined);
  const [selectedBookableEvent, setSelectedBookableEvent] = React.useState(undefined);
  ...
  const [dropdownTimezone, setDropdownTimezone] = React.useState(null);
  ...
  const onChange = newDate => {
    if (newDate) {
      ...
      if (isMounted) {
        if (viewAs === ViewType.CalendarBook || viewAs === ViewType.CalendarExclusiveBook) {
  ...
  const fetchReservationAvailability = (queryStartTime, queryEndTime, getDuration = GetEventsDuration.WholeMonth) => {
    fetchReservationTerms(id, queryStartTime, queryEndTime, host, authToken, getDuration).then(terms => {
      if (terms) {
  ...
  const fetchReservations = (queryStartTime, queryEndTime) => {
    fetchMyReservations(id, queryStartTime, queryEndTime, authToken, host).then(myReservations => {
      if (myReservations) {
  ...
  const fetchCalendarEvents = (queryStartTime, queryEndTime) => {
    fetchCalendarView(id, queryStartTime, queryEndTime, host, authToken, location).then(newCalendarEvents => {
  ...
  const cancelReservation = () => {
    ...
    deleteReservation(selectedReservation.reservationId, host, authToken).then(success => {
      if (success) {
  ...
  useEffect(() => {
    if (!isMounted) {
      ...
      timezoneData.forEach(tzDefinition => tzDefinition.utc.forEach(tzName => {
      ...
      if (startDate) {
        ...
        } else if (viewAs === ViewType.CalendarBook || viewAs === ViewType.CalendarExclusiveBook) {
  ...
  const renderDayCalendarByLocation = () => {
    ...
    return /*#__PURE__*/React.createElement(DayCalendarGroupedByLocation, {
      events: events,
  ...
  const renderCalendarView = () => {
    ...
    }), !events || !events.length ? /*#__PURE__*/React.createElement(Text, {
      style: style.eventNotFound
    }, "No scheduled events found") : '', events && events.length > 0 ? /*#__PURE__*/React.createElement(EventDetailList, {
      eventList: events,
      key: 'detail-list',
      renderEventFunc: renderEventFunc,
      descriptionLength: descriptionLength,
  ...
  const renderCalendarExclusiveBook = () => {
    return /*#__PURE__*/React.createElement(View, null, /*#__PURE__*/React.createElement(CalendarExclusiveBook, {
      startTime: startTime,
      availability: availability,
      onPress: newDate => onChange(newDate)
    }), renderAvailableEventsToBook(), /*#__PURE__*/React.createElement(View, null, /*#__PURE__*/React.createElement(Text, {
      style: style.sectionHeader2
    }, "Time zone"), getTimezoneSelector()), bookingResult ? /*#__PURE__*/React.createElement(ReservationSuccessModal, {
  ...
  const renderAvailableEventsToBook = () => {
    ...
    return /*#__PURE__*/React.createElement(View, null, availability.resources.map(function (resource, idx) {
      ...
      }, resource.name), /*#__PURE__*/React.createElement(BookableEventList, {
        resource: resource,
        startTime: startTime,
        descriptionLength: descriptionLength,
  ...
  const renderCalendarBook = () => {
    return /*#__PURE__*/React.createElement(View, null, /*#__PURE__*/React.createElement(CalendarBook, {
      startTime: startTime,
      availability: availability,
      onPress: newDate => onChange(newDate)
    }), /*#__PURE__*/React.createElement(AvailabilitiesForADay, {
      key: 'available-times',
      timezone: timezone.toString(),
      startTime: startTime,
      availability: availability,
      ...
      style: style.sectionHeader2
    }, "Time zone"), getTimezoneSelector()), bookingResult && selectedBookableEvent ? /*#__PURE__*/React.createElement(ReservationSuccessModal, {
      key: 'reservation-success',
      timezone: timezone.toString(),
      bookingResult: bookingResult,
  ...
  const reserveDialog = resourceOrEvent => {
    if (bookingDialog === undefined && selectedBookableEvent === undefined) {
      ...
      return /*#__PURE__*/React.createElement(ReservationModal, {
  ...
  function submitReservation() {
    ...
    submitBookReservation(id, resourceOrEvent, host, authToken, nameText, emailText, notesText).then(bookingResponse => {
  ...
  const getTimezoneSelector = () => {
    ...
    return /*#__PURE__*/React.createElement(DropDownPicker, {
  ...
  const renderDayListWithDaySelector = () => {
    ...
    }, startTime.toDateString()), /*#__PURE__*/React.createElement(Button, {
      style: style.prevNextButton,
      title: '>',
      onPress: () => fetchDay(addDays(startTime, 1))
    })), !events || !events.length ? /*#__PURE__*/React.createElement(Text, null, "No events scheduled for today") : '', events && events.length > 0 ? /*#__PURE__*/React.createElement(EventDetailList, {
      eventList: events,
      key: 'detail-list',
      renderEventFunc: renderEventFunc,
      descriptionLength: descriptionLength,
  ...
  const renderDayList = () => {
    return /*#__PURE__*/React.createElement(View, null, !events || !events.length ? /*#__PURE__*/React.createElement(Text, null, "No events scheduled for today") : '', events && events.length > 0 ? /*#__PURE__*/React.createElement(EventDetailList, {
      eventList: events,
      key: 'detail-list',
      renderEventFunc: renderEventFunc,
      descriptionLength: descriptionLength,
  ...
  const renderList = () => {
    return /*#__PURE__*/React.createElement(View, {
      ...
      style: style.emptySectionText
    }, "No events found") : '', events && events.length > 0 ? /*#__PURE__*/React.createElement(EventListGroupedByDay, {
      events: events,
      descriptionLength: descriptionLength,
      renderEventFunc: renderEventFunc,
      onPress: e => {
  ...
  const renderMyReservationsList = () => {
    return /*#__PURE__*/React.createElement(View, {
      style: style.viewContainer
    }, !reservations || !reservations.length ? /*#__PURE__*/React.createElement(Text, {
      style: style.emptySectionText
    }, "No reservations found") : '', reservations && reservations.length > 0 ? /*#__PURE__*/React.createElement(SingleDayReservationList, {
  ...
  const viewMyReservation = () => {
    ...
    return /*#__PURE__*/React.createElement(ViewReservation, {
  ...
  return /*#__PURE__*/React.createElement(SafeAreaView, null, renderView());
};
